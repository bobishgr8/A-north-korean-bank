...
$user = new userDAO;
$status = "first_time";
$curr_pw = $user->get_hashed_pw($stateID);
var_dump($stateID);
var_dump($status);
                ...
                <div class="column">
                    ...
                    <div class="field">
                        ...
                        <p class="control has-icons-left has-icons-right">
                          <input class="input" name="OLDpassword" type="text" placeholder="Current Password" required>
                      ...
                      <div class="field">
                        ...
                        <p class="control has-icons-left">
                          <input class="input" name="NEWpassword1" type="password" placeholder="New Password" required>
                          <span class="icon is-small is-left">
                            <i class="fas fa-lock"></i>
                          </span>
                        </p>
                      ...
                      <div class="field">
                        Repeat Password:
                        <p class="control has-icons-left">
                          <input class="input" name="NEWpassword2" type="password" placeholder="New Password AGAIN" required>
                          <span class="icon is-small is-left">
                            <i class="fas fa-lock"></i>
                          </span>
                        </p>
