...
if(array_key_exists("deposit",$_POST)){
    ...
    $status = $temp->deposit($_SESSION["bankBoi"],$_POST["amount"]);
    var_dump($status);      
}else{
            ...
            <div class="columns">
                ...
                <div class="column">
                    ...
                    <form action="./deposit_money.php" method="POST">
                      <br><br>
                      <p class="subtitle">Deposit fund amount:</p>
                        <div class="field">
                      ...
                      <div class="field is-grouped is-grouped-centered">
                        <p class="control">
                            <input type="submit" value="Submit" name="deposit" class="button is-success">
                        </p>
                        <p class="control">
