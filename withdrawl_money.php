...
$status = "first_time";
var_dump($status);
if(array_key_exists("withdrawal",$_POST)){
    $temp = new loanAccountDAO();
    $status = $temp->withdrawal($_SESSION["bankBoi"],$_POST["amount"]);
    var_dump($status);      
}else{
        ...
        <div class="block">
            <div class="columns">
                ...
                <div class="column">
                    ...
                    ?>
                    <form action="./withdrawl_money.php" method="POST">
                      <br><br>
                      <p class="subtitle">Withdrawal fund amount:</p>
                        <div class="field">
                      ...
                      <div class="field is-grouped is-grouped-centered">
                        <p class="control">
                            <input type="submit" value="Submit" name="withdrawal" class="button is-success">
                        </p>
                        <p class="control">
